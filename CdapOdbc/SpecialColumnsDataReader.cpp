...
void Cask::CdapOdbc::SpecialColumnsDataReader::getColumnValue(const ColumnBinding& binding) const {
}
...
bool Cask::CdapOdbc::SpecialColumnsDataReader::canReadFast() const {
  return true;
}
